...
namespace CommandLine
{
    ...
    public sealed class NameInfo : IEquatable<NameInfo>
    {
        ...
        public override bool Equals(object obj) => obj is NameInfo other ? Equals(other) : base.Equals(obj);

        /// <summary>
        /// Serves as a hash function for a particular type.
        /// </summary>
        /// <remarks>A hash code for the current <see cref="System.Object"/>.</remarks>
        public override int GetHashCode() => new { ShortName, LongName }.GetHashCode();
        ...
        public bool Equals(NameInfo other) => other == null ? false : ShortName.Equals(other.ShortName) && LongName.Equals(other.LongName);
    }
}
